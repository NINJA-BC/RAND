...
bot = telebot.TeleBot('7445045993:AAEhk9Rcfj4r8V9EwFAcfAhMp0W-T8kMV0Y')
...
def handle_attack(message):
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            response = "𝗨𝘀𝗮𝗴𝗲 :- /attack <𝘁𝗮𝗿𝗴𝗲𝘁> <𝗽𝗼𝗿𝘁> <𝘁𝗶𝗺𝗲>"  # Updated command syntax
    else:
        response = " 𝙔𝙊𝙐 𝘼𝙍𝙀 𝙉𝙊𝙏 𝘼𝙋𝙋𝙍𝙊𝙑𝙀𝘿 𝙏𝙊 𝙐𝙎𝙀 𝙏𝙃𝙄𝙎 𝘽𝙊𝙏. 𝙋𝙇𝙀𝘼𝙎𝙀 𝘾𝙊𝙉𝙏𝘼𝘾𝙏 𝙏𝙃𝙀 𝘼𝘿𝙈𝙄𝙉 🥷 --> @VimPixss."
